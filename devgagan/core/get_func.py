...
# Telegram: https://t.me/Mr_Abhijit_1
...
if STRING:
    ...
    print("App imported from saurabh.")
else:
    pro = None
        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__MR Abhijit__**."
                )
                return
...
async def send_settings_message(chat_id, user_id):
    ...
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/Mr_Abhijit_1")]
    ]
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **SpyLib ⚡**, built on Telethon(base), by Saurabh still in beta.__", buttons=buttons)
    ...
    try:
        ...
        if freecheck == 1:
            reply_markup = InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/Mr_Abhijit_1")]
                ]
            )
